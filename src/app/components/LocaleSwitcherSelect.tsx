...
export default function LocaleSwitcherSelect({
  ...
  function onSelectChange(event: ChangeEvent<HTMLSelectElement>) {
    ...
    const currentDomain = getDomainForLocale(currentLocale) || "";
    const targetDomain = getDomainForLocale(nextLocale) || "";
  ...
  function getDomainForLocale(locale: string): string | undefined {
    return (
      routing?.domains?.find((d) => (d.locales as string[]).includes(locale))
        ?.domain ?? ""
    );
  }
